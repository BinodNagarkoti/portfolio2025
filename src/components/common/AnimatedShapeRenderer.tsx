...
const AnimatedShapeRenderer: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    const basePositions: Array<[number, number]> = [
      [0, 3 * Y_UNIT],                 // Top center
      [-X_UNIT, 2 * Y_UNIT],           // Top-left
      [X_UNIT, 2 * Y_UNIT],            // Top-right
      [-X_UNIT * 1.33, Y_UNIT],        // Mid-left upper
      [0, Y_UNIT],                     // Center upper
      [X_UNIT * 1.33, Y_UNIT],         // Mid-right upper
      [-X_UNIT, 0],                    // Mid-left center
      [X_UNIT, 0],                     // Mid-right center
      [-X_UNIT * 1.33, -Y_UNIT],       // Mid-left lower
      [0, -Y_UNIT],                    // Center lower
      [X_UNIT * 1.33, -Y_UNIT],        // Mid-right lower
      [0, -3 * Y_UNIT],                // Bottom center
    ];
  ...
  return (
    <div className="w-full h-[300px] md:h-[400px] cursor-grab active:cursor-grabbing">
      {/* @ts-ignore due to potential R3F type complexities with extended JSX */}
...
export default AnimatedShapeRenderer;
